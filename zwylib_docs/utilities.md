...
### `zwylib.SingletonMeta`[](#zwylibsingletonmeta)
...
### `zwylib.Callback1`[](#zwylibcallback1)
...
### `zwylib.copy_to_clipboard`[](#zwylibcopy_to_clipboard)
...
*   `bulletin_helper` (`OptionalBulletinHelper]`): Instance of a bulletin helper to show the success message. If `None`, no bulletin is shown.
...
### `zwylib.download_and_install_plugin`[](#zwylibdownload_and_install_plugin)
...
### `zwylib.get_plugin`[](#zwylibget_plugin)
...
### `zwylib.arraylist_to_list`[](#zwylibarraylist_to_list)
...
### `zwylib.list_to_arraylist`[](#zwyliblist_to_arraylist)
...
### `zwylib.format_exc`[](#zwylibformat_exc)
...
### `zwylib.format_exc_from`[](#zwylibformat_exc_from)
...
### `zwylib.format_exc_only`[](#zwylibformat_exc_only)
...
### `zwylib.is_zwylib_version_sufficient`[](#zwylibis_zwylib_version_sufficient)
